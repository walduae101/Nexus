...
`;
  ...
  8. IMMEDIATE SCRATCHPAD SYNC: When you acknowledge a critical, project-blocking bug (e.g., deployment routing anomaly as seen in image_6.png), you MUST explicitly state that you are forcing an immediate scratchpad update. This signals the background process to bypass token-saving loops and push the state to Firestore immediately.
